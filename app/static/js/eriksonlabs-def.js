...
var eTp={
	...
	mostrar: '<div class="alert elements">@text</div>',
	...
	return {
		...
		SymTab: { 
			...
			fnEriksonLoadTable: function(){
				...
				this.eKeywords["o"]       		= eCs.__O__;
				this.eKeywords["y"]       		= eCs.__Y__;
						...
						while(this.fnToken().valor==eCs.__Y__ || this.fnToken().valor==eCs.__O__){
							...
							switch(this.fnToken().valor){
								case eCs.__Y__:
									...
									valor=(valor && this.fnTerminoCondicion(first));
									break;
								case eCs.__O__:
